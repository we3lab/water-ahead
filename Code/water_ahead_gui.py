...
def main():
    ...
    Label(tab8, text='$', font=('Arial', 10)).grid(column=26, row=3)
    Label(tab8, text='$', font=('Arial', 10)).grid(column=26, row=5)
    Label(tab8, text='$', font=('Arial', 10)).grid(column=26, row=7)
    ...
    Label(tab8, text='$/yr', font=('Arial', 10)).grid(column=35, row=3)
    Label(tab8, text='$/yr', font=('Arial', 10)).grid(column=35, row=5)
    Label(tab8, text='$/yr', font=('Arial', 10)).grid(column=35, row=7)
    ...
    def calculate_results():
        ...
        Label(tab8, text=empty_results, font=('Arial', 10, 'bold')).grid(column=27, row=3)
        Label(tab8, text=empty_results, font=('Arial', 10, 'bold')).grid(column=27, row=5)
        Label(tab8, text=empty_results, font=('Arial', 10, 'bold')).grid(column=27, row=7)
